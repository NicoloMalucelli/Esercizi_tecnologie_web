...
if(isset($_POST["nome"]) && isset($_POST["email"]) && isset($_POST["contact"])){
  filter_var($_POST["email"], FILTER_SANITIZE_EMAIL);
  filter_var($_POST["contact"], FILTER_VALIDATE_INT);
  $_SESSION["post"] = array($_POST["email"], $_POST["contact"]);
  $_SESSION["error"] = null;
} else {
  $_SESSION["error"] = "errore in pagina 1";
  header("index.php");
}
